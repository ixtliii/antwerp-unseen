...
// Procedural sound matching the ConstellationNav 'click' style
const playCloseTone = () => {
    ...
    // Using a 'triangle' wave for that digital/constellation feel
    osc.type = 'triangle';
...
const LocationPanel = ({ pin, onClose, onAddStory }: LocationPanelProps) => {
    ...
    const handleClose = useCallback(() => {
        ...
        // Faster, punchier animation without the performance-heavy filter
